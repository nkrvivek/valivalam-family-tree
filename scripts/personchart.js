...
function initPersonChart() {
    ...
    lighterMaleBoxColor = lighterHexColor(maleBoxColor, 0.04044699);
    lighterFemaleBoxColor = lighterHexColor(femaleBoxColor, 0.04044699);
    
    unknownGenderBoxColor = '#DDD';
    lighterUnknownGenderBoxColor = lighterHexColor(unknownGenderBoxColor, 0.04044699);
